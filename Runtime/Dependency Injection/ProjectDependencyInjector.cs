// Runtime DI using a serialized object, commented out cause the current DI implementation seem better
...
//             concrete.Item1 = TypeFinder.GetAllDerivedTypes(typeof(T)).FirstOrDefault(scopeFilters[(int)scope]);
